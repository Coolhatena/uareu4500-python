...
def open_device(device_name):
	...
	result = fingerprint_lib.open_device(device_name, ctypes.byref(hReader))
...
if __name__ == "__main__":
	...
	# print("Abriendo dispositivos...")
	# result, device_name = search_devices()
	# print("Resultado:", result)
	# print("Nombre del dispositivo", device_name)

	# result, hReader = open_device(device_name.decode('utf-8'))
	# print("Resultado:", result)
	fingerprint_lib.main()
